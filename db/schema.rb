...
ActiveRecord::Schema.define(version: 20151122105642) do
  ...
  create_table "caffes", force: :cascade do |t|
    ...
    t.integer  "checkins_count", limit: 4
  ...
  create_table "caffes_postal_codes", id: false, force: :cascade do |t|
    t.integer "caffe_id",       limit: 4
    t.integer "postal_code_id", limit: 4
  end

  add_index "caffes_postal_codes", ["caffe_id"], name: "index_caffes_postal_codes_on_caffe_id", using: :btree
